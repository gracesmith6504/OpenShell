...
# supervisor Deployment and uses NetworkPolicy to force agent egress through it. In
# sidecar and proxy-pod modes, the agent container runs non-root with no added
