...
sidecar, cni-sidecar, and proxy-pod modes use `network-only` process
supervision. Use RuntimeClass isolation as an additional workload boundary, not
as a replacement for combined topology.
